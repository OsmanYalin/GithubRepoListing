...
class FragmentToolbar(
    ...
    val onBackPressed: View.OnClickListener?,
    ...
    class Builder {
        ...
        private var onBackPressed: View.OnClickListener? = null
        ...
        fun onBackPressed(onBackPressed: View.OnClickListener) = apply { this.onBackPressed = onBackPressed }
